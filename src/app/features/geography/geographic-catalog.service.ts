...
export class GeographicCatalogService {
  ...
  getNeighborhoodDetail(neighborhoodId: string): Observable<NeighborhoodDetailResponse> {
    return this.http.get<NeighborhoodDetailResponse>(`${this.base}/neighborhoods/${neighborhoodId}`);
  }
}
